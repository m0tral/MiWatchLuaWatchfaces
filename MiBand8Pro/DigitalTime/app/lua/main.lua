...
local function entry()
    ...
    watchface.timeHourHigh =	Image(root, "num_0.bin", pos.timeHourHigh)
    watchface.timeHourLow =		Image(root, "num_0.bin", pos.timeHourLow)
    watchface.timeDelim =       Image(root, "delim.bin", pos.timeDelim)
    watchface.timeMinuteHigh =	Image(root, "num_0.bin", pos.timeMinuteHigh)
    watchface.timeMinuteLow =	Image(root, "num_0.bin", pos.timeMinuteLow)
